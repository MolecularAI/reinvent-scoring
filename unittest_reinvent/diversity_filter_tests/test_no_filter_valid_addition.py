...
from unittest_reinvent.fixtures.test_data import BUTANE
from unittest_reinvent.diversity_filter_tests.fixtures import tanimoto_scaffold_filter_arrangement


class TestNoFilterValidAddition(BaseTanimotoSimilarity):

    def setUp(self):
        super().setUp()

        self.final_summary = tanimoto_scaffold_filter_arrangement([BUTANE], [1.0], [0])
