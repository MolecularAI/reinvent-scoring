...
class TestLinkerLengthRatioScoreWithDoubleSigmoid(BaseSetup):
    ...
    def setUp(self):
        ...
        super().init(self.sf_enum.LINKER_LENGTH_RATIO, specific_parameters)
        super().setUp()

    def test_linker_length_ratio_with_double_sigmoid(self):
        ...
        values = np.array([0.09, 0.80, 0.34, 0.49, 0.34])
