...
class TestLinkerNumSP2AtomsNoTransformation(BaseSetup):
    def setUp(self):
        super().setup_attrs()
        super().init(self.sf_enum.LINKER_NUM_SP2_ATOMS, {})
        super().setUp()

    def test_linker_num_sp2_atoms_no_transformation(self):
