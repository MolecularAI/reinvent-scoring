...
class TestParallelScoringFunctionFactory(unittest.TestCase):
    ...
    def setUp(self):
        ...
        sf_parameters = ScoringFunctionParameters(name=sf_enum.CUSTOM_PRODUCT, parameters=[ts_parameters], parallel=True)
